# 📋 Datos para la página web del Dr.

Llena los campos escribiendo después de cada flecha `→`.
Si algún dato aún no lo tienes, **déjalo vacío** — la página conservará el
texto de ejemplo en ese punto y se podrá actualizar después.
...
**WhatsApp** (9 dígitos, el número donde recibirás las citas)
Ejemplo: `987 654 321`

→ +51 928 471 815

**Teléfono fijo** (opcional, solo si es distinto al WhatsApp)
Ejemplo: `(01) 234 5678`

→ +51 928 471 815

**Correo electrónico** (opcional)
Ejemplo: `consultas@raulsuker.com`

→ sucari1201@gmail.com
...
**Dirección completa**
Ejemplo: `Av. Larco 345, Oficina 302, Miraflores, Lima`

→ AV. 3 de Octubre 322 JULIACA-PUNO-PERÚ
...
**Pacientes atendidos (aproximado)**

→ 10,000 (aprox) pacientes atendidos

**Años de residencia quirúrgica** (o escribe otra cifra que prefieras
destacar, por ejemplo "cirugías realizadas")
...
## 6. Redes sociales (opcional — se agregan al pie de página)
...
Copia los archivos a la carpeta `assets/` de este mismo sitio
(`c:\Users\USER\Downloads\raulsuker.com\assets\`). Sirve cualquier formato
y tamaño — yo las recorto, comprimo y coloco.
...
✅ **Cuando termines de llenar esto, solo dime "ya llené los datos"**
y aplico todo a la página de una sola vez.